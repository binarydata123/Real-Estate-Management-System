      ...
      >
        ...
        <div>
          <select
            ...
            className="w-full px-[11px] py-[11px] border border-gray-300 rounded-lg focus:ring-1 focus:ring-primary focus:border-primary hover:bg-green-100 hover:border-green-500"
          >

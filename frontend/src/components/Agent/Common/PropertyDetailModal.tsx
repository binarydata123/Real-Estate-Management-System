            ...
            <div className="bg-white rounded-lg md:rounded-xl  shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-2 md:p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8">
                        ...
                        <div className="space-y-2">
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900 md:mb-3 mb-1 flex items-center justify-between">
                                    Property Details
                                    <span className={` capitalize inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(property.status)}`}>
                                        {property.status}
                                    </span>
                                </h3>
                                <div className="md:space-y-3 grid grid-cols-2 gap-2">
                                    ...
                                    {property.size && (
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium text-gray-900">{property.size} {property.size_unit ?? ''}</span>
                                        </div>
                                    )}
                                    {property.bedrooms && (
                                        <div className="flex justify-between">
                        ...
                        <div className="space-y-2">
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900 md:mb-3 mb-1">Description</h3>
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900 md:mb-3 mb-1">Features</h3>

        ...
        <div className="space-y-2">
            ...
            <div className="md:space-y-4 space-y-2">
                {meetings.map((meeting) => (
                    <div key={meeting.id} className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-200 p-2 md:p-6 hover:shadow-md transition-shadow">
                            ...
                            <div className="flex-1 w-full md:w-auto">
                                <div className="flex items-center space-x-3 md:mb-3 mb-2 w-full md:w-auto">
                                    ...
                                    <div className="w-full md:w-auto">
                                        <h3 className="text-lg font-semibold text-gray-900">Meeting with {meeting.customer}</h3>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-4 text-sm md:mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-gray-900">{meeting.property ?? "—"}</p>
                                    </div>
                                </div>
                            </div>
            ...
            {meetings.length === 0 && (
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 mb-6">Start scheduling meetings with your customers</p>
                    <button
                        onClick={() => setShowAddForm(true)}

...
interface AddCustomerSelectionModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSelectMode: (mode: "manual" | "ai") => void;
}

export const AddCustomerSelectionModal: React.FC<
  AddCustomerSelectionModalProps
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        ...
        <Dialog.Panel className="w-full max-w-2xl rounded-2xl bg-gradient-to-br from-gray-50 to-blue-50 p-8 shadow-2xl">
          <Dialog.Title className="text-center text-2xl font-bold text-gray-800 mb-2">
            How would you like to add a customer?
          </Dialog.Title>
          <Dialog.Description className="text-center text-gray-600 mb-8">
            Select your preferred method for adding a new customer.
          </Dialog.Description>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                Fill out the customer details yourself using our guided form.
              </p>
            </button>
            {/* AI Assistant Card */}
            <button

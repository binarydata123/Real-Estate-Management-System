...
export const AgentDashboard = () => {
    ...
    const recentProperties: Property[] = [
        {
            ...
            description: 'Beautiful 3BHK apartment with modern amenities, spacious rooms, and excellent connectivity.',
        },
        {
            id: '2',
            ...
            size_unit: 'sq ft',
            status: 'available',
            images: ['https://images.pexels.com/photos/373912/pexels-photo-373912.jpeg'],
            created_at: '2025-01-08T14:30:00Z',
            description: 'Premium commercial office space in prime location with modern infrastructure.',
        },
    ];
    ...
    return (
        <div className="space-y-2 md:space-y-8">
            {/* Welcome Section */}
            <div>
                <h1 className="text-3xl font-bold text-gray-900 md:mb-2">Welcome back!</h1>
            ...
            <div>
                <div className="flex items-center justify-between mb-2 md:mb-6">
                    ...
                    <Link href="/agent/properties" className="text-blue-600 hover:text-blue-700 font-medium text-sm">
                        View All
                    </Link>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-6">
                    {recentProperties.map((property) => (
                        <PropertyCardForDashboard
                            ...
                            onFavorite={(property) => console.log('Favorite property:', property)}
                        />
                    ))}
                </div>
            </div>

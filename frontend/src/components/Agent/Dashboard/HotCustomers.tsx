                    ...
                    <div className="space-y-2 md:space-y-4">
                        {customers.map((customer) => (
                            ...
                            >
                                ...
                                <div className="text-right flex items-start gap-2 justify-end">
                                    {/* Uncomment if you want to show temperature badge */}
                                    {/* <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getTemperatureColor(customer.temperature)}`}>
                    {customer.temperature}
                  </span> */}
                                    <p className="text-xs text-gray-500 capitalize md:mt-1">{customer.status}</p>

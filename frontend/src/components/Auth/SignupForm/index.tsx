...
const SignupForm = () => {
  ...
  const handleSignup = async (registrationData: SignupFormData) => {
    ...
    try {
      ...
      const { error: loginError, data: loginData } = await signIn(response);
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="relative">
              ...
              <span
                ...
                className="absolute bottom-3 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600"
          ...
          <div className="space-y-4 pt-4 border-t border-gray-200">
            <InputField
              ...
              name="agencyName"
              placeholder="Your Awesome Agency"
              register={register}

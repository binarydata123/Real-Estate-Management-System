    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (response.data.requiresSelection) {
          ...
          const { error: signInError, data: signInData } = await signIn(response);
          if (signInError) {
      ...
      <div className="max-w-md w-full bg-[#C9A24D]/20 rounded-xl shadow-sm md:p-8 p-6 border-1 border-[#C9A24D]">
        ...
        <div className="text-center mb-1">
          <div className="inline-flex flex-col items-center justify-center mb-2">
            ...
            <p className="text-gray-600 text-sm mt-1">Real Estate Management System</p>
          </div>
        </div>
        ...
        {agenciesToSelect ? (
          ...
          <div className="space-y-4">
            <div className="relative mb-6 text-center">
              ...
              <h2 className="text-lg font-semibold text-[#0A2540]">Select Your Agency</h2>
            </div>
            ...
            <div className="space-y-3">
              {agenciesToSelect.map((agency) => (
                ...
                >
                  <span className="font-medium text-[#0A2540]">{agency.name}</span>
          ...
          <div className="space-y-4">
            <h2 className="text-center text-lg font-semibold text-[#0A2540]">Sign in to your account</h2>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-sm text-gray-600">Manage your real estate business</p>
                </div>
                <ChevronRightIcon className="h-5 w-5 text-gray-400" />
              </button>
          ...
          <>
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#0A2540] text-white py-3 rounded-lg font-medium hover:bg-[#0A2540]/90 focus:outline-none focus:ring-2 focus:ring-[#0A2540] focus:ring-offset-2 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {loading ? (

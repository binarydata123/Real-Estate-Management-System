...
export type LoginData = z.infer<typeof agencyLoginSchema | typeof customerLoginSchema>;
                ...
                {agenciesToSelect ? (
                    ...
                    <div className="space-y-3 md:space-y-6">
                        <div className="relative mb-2 md:mb-4 text-center">
                            <button
                                onClick={() => { setAgenciesToSelect(null); setLoginAs(null); }}
                            ...
                            <h2 className="text-center text-sm md:text-xl font-semibold text-gray-800 inheritClass">Select Your Agency</h2>
                        </div>
                        <div className="grid grid-cols-1 gap-3">
                            {agenciesToSelect.map((agency) => (
                                ...
                                >
                                    <p className="font-semibold text-gray-800 text-left flex-1">{agency.name}</p>
                    ...
                    <div className="space-y-3 md:space-y-6">
                        <h2 className="text-center text-sm md:text-xl font-semibold text-gray-800 inheritClass">Sign in to your account</h2>
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    <p className="font-semibold text-gray-800 text-left">Agency / Agent</p>
                                    <p className="text-sm text-gray-600 text-left">Grow your business fast.</p>
                                </div>
                                <ChevronRightIcon className="h-5 w-5 text-gray-400 group-hover:text-blue-600 transition-transform duration-300 transform group-hover:translate-x-1" />
                            </button>
                            <button
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    <p className="font-semibold text-gray-800 text-left">Customer</p>
                                    <p className="text-sm text-gray-600 text-left">Find your dream home.</p>
                                </div>

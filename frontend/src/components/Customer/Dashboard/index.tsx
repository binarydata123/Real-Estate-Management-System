...
export default function CustomerDashboard() {
  ...
  const userStats = [
    {
      title: "Properties",
      value: dashboardData?.totalSharedProperties || 0, // Use dynamic count based on toggle
        ...
        <div className="grid grid-cols-3 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
          {userStats.map((stat, index) => (
            <Link
              href={stat.href}
              key={index}
              className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 md:p-6 hover:shadow-md transition-shadow"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">

...
export default function AdminDashboard() {
    ...
    return (
        <div className="p-2 md:p-8 lg:p-12 bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen">
            ...
            <p className="text-lg text-gray-600 mb-3">Welcome! Here’s a quick overview of your platform’s activity and growth.</p>
                ...
                <dl className="grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    {isLoading
                        ...
                        : stats.map((item, index) => {
                            ...
                            return (
                                <div key={item.name} className="flex justify-between items-center rounded-xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 p-2 border-t-4 border-blue-500 group">
                                    <div className="">
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-blue-100 flex flex-col">
                        ...
                        <p className="text-gray-500 text-sm mb-4">Track how your user base is growing over time.</p>
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-purple-100 flex flex-col">
                        ...
                        <p className="text-gray-500 text-sm mb-4">See the trend of new property listings on the platform.</p>
                        <div className="flex-1 min-h-[18rem]">
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-2">
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-blue-100 overflow-x-auto">
                        ...
                        <p className="text-gray-500 text-sm mb-4">Newest users who joined the platform.</p>
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-blue-50">
                                    <tr>
                                        <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-blue-700 uppercase tracking-wider sm:pl-0">Name</th>
                                        <th scope="col" className="px-3 py-3.5 text-left text-xs font-semibold text-blue-700 uppercase tracking-wider">Role</th>
                                        <th scope="col" className="px-3 py-3.5 text-left text-xs font-semibold text-blue-700 uppercase tracking-wider">Joined</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-100">
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-purple-100 overflow-x-auto">
                        ...
                        <p className="text-gray-500 text-sm mb-4">Latest agencies registered on the platform.</p>
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-purple-50">
                                    <tr>
                                        <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-purple-700 uppercase tracking-wider sm:pl-0">Agency Name</th>
                                        <th scope="col" className="px-3 py-3.5 text-left text-xs font-semibold text-purple-700 uppercase tracking-wider">Email</th>
                                        <th scope="col" className="px-3 py-3.5 text-left text-xs font-semibold text-purple-700 uppercase tracking-wider">Phone</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-100">
                                    {recentAgencies.map((agency) => (
                                        <tr key={agency._id} className="hover:bg-purple-50 transition-colors">

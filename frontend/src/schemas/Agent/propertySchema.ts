...
export const propertySchema = z
  .object({
    ...
    category: z
      .enum(
        ["plot", "flat", "showroom", "office", "villa", "land", "farmhouse"],
        {
  ...
  .superRefine((data, ctx) => {
    ...
    if (data.type && data.category) {
      if (data.type === "residential") {
        // Check if category is valid for the selected type
        if (
          !residentialCategories.includes(
            data.category as (typeof residentialCategories)[number]
          )
        ) {
          ctx.addIssue({
            code: "custom",
        ...
        if (
          !commercialCategories.includes(
            data.category as (typeof commercialCategories)[number]
          )
        ) {
          ctx.addIssue({
            code: "custom",
    ...
    if (
      data.built_up_area !== undefined &&
      data.carpet_area !== undefined &&
      data.carpet_area > data.built_up_area
    ) {
      ctx.addIssue({
        code: "custom",
        path: ["carpet_area"],
...
export const propertyTypeOptions: IconCheckboxOption[] = [
  {
    value: "residential",
    label: "Residential",
    icon: React.createElement(ResidentialIcon, { size: 16 }),
  },
  {
    value: "commercial",
    label: "Commercial",
...
export const furnishingOptions: IconCheckboxOption[] = [
  {
    value: "furnished",
    label: "Furnished",
    icon: React.createElement(Sofa, { size: 16 }),
  },
  {
    value: "semi furnished",
    label: "Semi-Furnished",
    icon: React.createElement(Sofa, { size: 16, strokeWidth: 1.5 }),
  },
  {
    value: "unfurnished",
    label: "Unfurnished",
    icon: React.createElement(Sofa, { size: 16, strokeWidth: 1 }),
  },
];
...
export const powerBackupOptions: IconCheckboxOption[] = [
  {
    value: "none",
    label: "None",
    icon: React.createElement(ZapOff, { size: 16 }),
  },
  {
    value: "partial",
    label: "Partial",
    icon: React.createElement(BatteryMedium, { size: 16 }),
  },
  {
    value: "full",
    label: "Full",
    icon: React.createElement(BatteryCharging, { size: 16 }),
  },
];
...
export const commercialCategoryOptions: IconCheckboxOption[] = [
  ...
  },
  {
    ...
    icon: React.createElement(LandPlot, { size: 16 }),
  },
];
...
export const featuresOptions: IconCheckboxOption[] = [
  ...
  },
  {
    ...
    icon: React.createElement(AirVent, { size: 16 }),
  },
  {
    value: "modular kitchen",
    label: "Modular Kitchen",
    icon: React.createElement(CookingPot, { size: 16 }),
    categories: ["flat", "villa", "farmhouse"],
  },
  {
    value: "piped gas",
    label: "Piped Gas",
    icon: React.createElement(Flame, { size: 16 }),
    categories: ["flat", "villa"],
  },
  {
    value: "power backup",
    label: "Power Backup",
  ...
  },
  {
    value: "wifi",
    label: "Wi-Fi",
    icon: React.createElement(Wifi, { size: 16 }),
  },
  {
    value: "terrace garden",
    label: "Terrace/Garden",
    icon: React.createElement(Shrub, { size: 16 }),
    categories: ["villa", "farmhouse", "flat"],
  },
  {
    value: "intercom",
    label: "Intercom",
    icon: React.createElement(Phone, { size: 16 }),
    categories: ["flat", "office", "showroom", "villa"],
  },
  {
    value: "fire alarm",
    label: "Fire Alarm",
    icon: React.createElement(Siren, { size: 16 }),
  },
  {
    value: "study room",
    label: "Study Room",
...
export const amenitiesOptions: IconCheckboxOption[] = [
  {
    value: "lift",
    label: "Lift",
    icon: React.createElement(ArrowUpDown, { size: 16 }),
    categories: ["flat", "office", "showroom"],
  },
  {
    value: "security",
    label: "Security",
  ...
  },
  {
    value: "swimming pool",
    label: "Swimming Pool",
    icon: React.createElement(Waves, { size: 16 }),
    categories: ["flat", "villa", "farmhouse"],
  },
  {
    value: "park",
    label: "Park",
    icon: React.createElement(Trees, { size: 16 }),
  },
  {
    value: "clubhouse",
    label: "Clubhouse",
  ...
  },
  {
    ...
    icon: React.createElement(ToyBrick, { size: 16 }),
    categories: ["flat", "villa"],
  },
  {
    value: "jogging track",
  ...
  },
  {
    ...
    icon: React.createElement(Volleyball, { size: 16 }),
    categories: ["flat", "villa"],
  },
  {
    value: "tennis court",
    label: "Tennis Court",
    icon: React.createElement(TennisBallIcon, { size: 16 }),
    categories: ["flat", "villa"],
  },
  {
    value: "indoor games",
  ...
  },
  {
    value: "library",
    label: "Library",
    icon: React.createElement(LibraryIcon, { size: 16 }),
    categories: ["flat", "villa"],
  },
  {
    value: "cafeteria",
  ...
  },
  {
    ...
    icon: React.createElement(Droplet, { size: 16 }),
  },
];
...
export const ownershipTypeOptions: IconCheckboxOption[] = [
  ...
  },
  {
    ...
    icon: React.createElement(HandHelping, { size: 16 }),
  },
];
...
export const plotDimensionUnitOptions: IconCheckboxOption[] = [
  {
    value: "feet",
    label: "Feet",
    icon: React.createElement(Ruler, { size: 16 }),
  },
  {
    value: "meter",
    label: "Meter",
...
export const waterSourceOptions: IconCheckboxOption[] = [
  ...
  },
  {
    value: "borewell",
    label: "Borewell",
    icon: React.createElement(DropletsIcon, { size: 16 }),
  },
  {
    value: "tanker supply",
    label: "Tanker Supply",
...
export const ownerTypeOptions: IconCheckboxOption[] = [
  ...
  },
  {
    value: "builder",
    label: "Builder",
    icon: React.createElement(HardHat, { size: 16 }),
  },
  {
    value: "agency",
    label: "Agency",

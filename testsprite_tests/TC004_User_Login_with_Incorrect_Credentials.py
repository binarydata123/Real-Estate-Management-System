...
async def run_test():
    ...
    try:
        ...
        # Find and navigate to the login page from the homepage.
        ...
        # Enter registered email 'agency@mailinator.com' and incorrect password 'wrongPassword123'.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/div/form/div/input').nth(0)
        ...
        # Assertion: Verify login failure with displayed error message indicating invalid credentials
        frame = context.pages[-1]
        error_locator = frame.locator('text=Invalid email or password.')
        assert await error_locator.is_visible(), 'Error message for invalid credentials is not visible'

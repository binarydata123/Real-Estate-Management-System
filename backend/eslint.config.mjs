export default [
    {
      ...
      rules: {
        ...
        "curly": "error", // Requires braces around loops and conditionals
        ...
        "quotes": "error", // Enforce consistent quote style
        ...
        "handle-callback-err": "error", // Enforces handling of callback errors
        "no-process-exit": "error", // Disallow process.exit()
        "no-sync": "error", // Warn on sync methods in async code
        "security/detect-non-literal-fs-filename": "error", // Detects dynamic filenames in fs methods
        "security/detect-object-injection": "error", // Prevents unsafe object property access
        "security/detect-child-process": "error", // Prevents child_process misuse
        ...
        "object-shorthand": "error", // Suggests shorthand property syntax
        ...
        "comma-dangle": "error", // Enforce consistent trailing commas
        ...
        "arrow-body-style": "error", // Enforce braces for arrow function bodies
      },
    },
  ];

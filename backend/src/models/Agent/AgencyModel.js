...
const agencySchema = new mongoose.Schema({
    name: { // Renamed from agencyName for consistency
        type: String,
        required: true,
        trim: true
    },
    slug: { // Added from registration form
        type: String,
        required: true,
        unique: true,
        lowercase: true,
    ...
    owner: { // Added to link to the creating user
        type: mongoose.Schema.Types.ObjectId,
        ref: 'User',
        required: true
    },
    email: { // Admin/contact email for the agency
        type: String,
        required: true,
        unique: true,
        lowercase: true,
    ...
    status: { // Added from frontend type
        type: String,
